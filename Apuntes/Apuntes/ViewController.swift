...
class ViewController: UIViewController, PDFViewDelegate, PDFDocumentDelegate {
    ...
    override func viewDidLoad() {
        ...
        let search = UIBarButtonItem(barButtonSystemItem: .search, target: self, action: #selector(prompForSearch))
    ...
    func load(_ name: String){
        ...
        //Cargar el PDF usando la clase PDFDocument, con la URL
    ...
    @objc func prompForSearch(){
        ...
        alert.addAction(UIAlertAction(title: "Canccelar", style: .cancel, handler: nil))
    ...
    func readText() {
        ...
        let pattern = "https://frogames.es [0-9a-z]" // "https://[a-z0-9].[]"
